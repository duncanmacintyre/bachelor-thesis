...
At the beginning, we should have assumed that we choose the smallest possible Hilbert space so that all states \(\op{\rho}\) can evolve to are in the Hilbert space. Then all \(\overline{\sigma_n} > 0\) and so (\ref{eq.deltaS.notinI}) doesn't vanish.
