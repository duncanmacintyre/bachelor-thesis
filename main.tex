...
\;\;-\;\;\frac{i}{\hbar}\lambda \int_{t_0}^t \left[\op{H}(t^\prime),\; \ket{{\Psi_I}_n, t_0}\bra{{\Psi_I}_n, t_0} \right] \,dt^\prime \\
& -\;\; \frac{\lambda^2}{\hbar^2} \int_{t_0}^t \int_{t_0}^{t^\prime} \left\{ \op{H}_I (t^\prime) \op{H}_I(t^{\prime\prime}),\; \ket{{\Psi_I}_n, t_0}\bra{{\Psi_I}_n, t_0} \right\}\,dt^{\prime\prime}\,dt^\prime \\
&+\;\; \frac{\lambda^2}{\hbar^2} \int_{t_0}^t \int_{t_0}^{t} \op{H}_I (t^\prime) \ket{{\Psi_I}_n, t_0}\bra{{\Psi_I}_n, t_0} \op{H}_I (t^{\prime\prime})\,dt^{\prime\prime}\,dt^\prime \;\;+\;\; \Od{\lambda^3}.
\end{align*}
Then
\begin{align}
...
& -\;\; \frac{\lambda^2}{\hbar^2} \int_{t_0}^t \int_{t_0}^{t^\prime} \left\{ \op{H}_I (t^\prime) \op{H}_I(t^{\prime\prime}),\; \op{\rho}(t_0) \right\}\,dt^{\prime\prime}\,dt^\prime \nonumber\\
...
\label{eq.rho1red}\overline{\op{\rho}}_1 &= -\frac{i}{\hbar} \int_{t_0}^t \sum_m \left(\cdot\otimes\bra{\beta_m}\right) \left[\op{H}(t^\prime),\; \op{\rho}_0 \right]\left(\cdot\otimes\ket{\beta_m}\right) \,dt^\prime\\
\label{eq.rho2red}\overline{\op{\rho}}_2 &= - \frac{1}{\hbar^2} \int_{t_0}^t \int_{t_0}^{t^\prime} \sum_m \left(\cdot\otimes\bra{\beta_m}\right) \left\{ \op{H}_I (t^\prime) \op{H}_I(t^{\prime\prime}),\; \op{\rho}_0 \right\}\left(\cdot\otimes\ket{\beta_m}\right)\,dt^{\prime\prime}\,dt^\prime \\
...
\overline{\sigma_n^{(1)}} = -\frac{i}{\hbar} \sum_m\int_{t_0}^t \left(\bra{\alpha_n^{(0)}}\otimes\bra{\beta_m}\right) \left[\op{H}(t^\prime),\; \op{\rho}_0 \right] \left(\ket{\alpha_n^{(0)}}\otimes\ket{\beta_m}\right)\,dt^\prime.
\end{equation}
If this is nonzero for some \(n\), (\ref{eq.deltaS}) gives
\begin{equation}
\Delta S = \left(-\frac{i}{\hbar}\lambda\log\frac{1}{\lambda}\right) \sum_{n \in I} \sum_m \int_{t_0}^t \left(\bra{\alpha_n^{(0)}}\otimes\bra{\beta_m}\right) \left[\op{H}(t^\prime),\; \op{\rho}_0 \right] \left(\ket{\alpha_n^{(0)}}\otimes\ket{\beta_m}\right)\,dt^\prime + \Od{\lambda}.
\end{equation}
...
Now,
\begin{align*}
\left(\bra{\alpha_n^{(0)}}\otimes\bra{\beta_m}\right) \op{H}(t^\prime) \op{\rho}_0 \left(\ket{\alpha_n^{(0)}}\otimes\ket{\alpha_m^{(0)}}\right) 
&= 
\sigma_{n,m}^{(0)} \left(\bra{\alpha_n^{(0)}}\otimes\bra{\beta_m}\right) \op{H}(t^\prime) \ket{\Psi_n^{(0)}} 
\\&=
 \left(\bra{\alpha_n^{(0)}}\otimes\bra{\beta_m}\right) \op{\rho}_0 \op{H}(t^\prime) \left(\ket{\alpha_n^{(0)}}\otimes\ket{\alpha_m^{(0)}}\right)
\end{align*}
...
\[
\bra{\alpha_n^{(0)}}\otimes\bra{\beta_m} \left\{ \op{H}_I (t^\prime) \op{H}_I(t^{\prime\prime}),\; \op{\rho}_0 \right\} \ket{\alpha_n^{(0)}}\otimes\ket{\beta_m} = 2 \sigma_{n,m}^{(0)} \bra{\alpha_n^{(0)}}\otimes\bra{\beta_m} \op{H}_I (t^\prime) \op{H}_I(t^{\prime\prime}) \ket{\alpha_n^{(0)}}\otimes\ket{\beta_m}
\]
we get
\begin{align}\label{entropyresultwithHI}
\Delta S &= \frac{1}{\hbar^2}\lambda^2 \log\frac{1}{\lambda^2}\sum_{n \in I}\sum_m \Bigg(2 \sigma_{n,m}^{(0)} \int_{t_0}^t \int_{t_0}^{t^\prime} \bra{\alpha_n^{(0)}}\otimes\bra{\beta_m} \op{H}_I (t^\prime) \op{H}_I(t^{\prime\prime}) \ket{\alpha_n^{(0)}}\otimes\ket{\beta_m}\,dt^{\prime\prime}\,dt^\prime \\
...
\begin{align*}
&\hspace{-4em}\Delta S =\frac{1}{\hbar^2}\lambda^2 \log\frac{1}{\lambda^2}\sum_{n \in I}\sum_m \Bigg(2 \sigma_{n,m}^{(0)} \int_{t_0}^t \int_{t_0}^{t^\prime} \bra{\alpha_n^{(0)}}\otimes\bra{\beta_m}\op{H}_I (t^\prime) \op{H}_I(t^{\prime\prime}) \ket{\alpha_n^{(0)}}\otimes\ket{\beta_m}\,dt^{\prime\prime}\,dt^\prime \\
...
&\hspace{-4em}\Delta S =\frac{1}{\hbar^2}\lambda^2 \log\frac{1}{\lambda^2} \Bigg(\sum_{n \in I}\sum_m2 \sigma_{n,m}^{(0)} \int_{t_0}^t \int_{t_0}^{t^\prime} \bra{\alpha_n^{(0)}}\otimes\bra{\beta_m}\op{H}_I (t^\prime) \op{H}_I(t^{\prime\prime}) \ket{\alpha_n^{(0)}}\otimes\ket{\beta_m}\,dt^{\prime\prime}\,dt^\prime \\
...
&\hspace{-4em}\Delta S =\frac{1}{\hbar^2}\lambda^2 \log\frac{1}{\lambda^2} \Bigg(\sum_{n \in I}\sum_m 2 \sigma_{n,m}^{(0)} \int_{t_0}^t \int_{t_0}^{t^\prime} \bra{\alpha_n^{(0)}}\otimes\bra{\beta_m}\op{H}_I (t^\prime) \op{H}_I(t^{\prime\prime}) \ket{\alpha_n^{(0)}}\otimes\ket{\beta_m}\,dt^{\prime\prime}\,dt^\prime \\
...
&\hspace{-4em}\Delta S =\frac{1}{\hbar^2}\lambda^2 \log\frac{1}{\lambda^2} \sum_{n \in I}\sum_m \sigma_{n,m}^{(0)} \Bigg( \Bigg[2\int_{t_0}^t \int_{t_0}^{t^\prime} \bra{\alpha_n^{(0)}}\otimes\bra{\beta_m}\op{H}_I (t^\prime) \op{H}_I(t^{\prime\prime}) \ket{\alpha_n^{(0)}}\otimes\ket{\beta_m}\,dt^{\prime\prime}\,dt^\prime \\
...
&\hspace{-4em}\Delta S =\frac{1}{\hbar^2}\lambda^2 \log\frac{1}{\lambda^2} \sum_{n \in I}\sum_m \sigma_{n,m}^{(0)} \Bigg( \int_{t_0}^t \int_{t_0}^{t^\prime} \bra{\alpha_n^{(0)}}\otimes\bra{\beta_m}\left[\op{H}_I (t^\prime),\; \op{H}_I(t^{\prime\prime})\right] \ket{\alpha_n^{(0)}}\otimes\ket{\beta_m}\,dt^{\prime\prime}\,dt^\prime \\
...
\hspace{-4.5em}
\Delta S =\frac{1}{\hbar^2}\lambda^2 \log\frac{1}{\lambda^2} \sum_{n \in I}\sum_m \sigma_{n,m}^{(0)} \Bigg( &\int_{t_0}^t \int_{t_0}^{t^\prime} \bra{\alpha_n^{(0)}}\otimes\bra{\beta_m}\left[\op{H}_I (t^\prime),\; \op{H}_I(t^{\prime\prime})\right] \ket{\alpha_n^{(0)}}\otimes\ket{\beta_m}\,dt^{\prime\prime}\,dt^\prime \\
&+\sum_{n^\prime \not\in I} \sum_{m^\prime} \left|\int_{t_0}^t \bra{\alpha_{n}^{(0)}}\otimes\bra{\beta_m} \op{H}_I (t^{\prime})\ket{\alpha_{n^\prime}^{(0)}}\otimes\ket{\beta_{m^\prime}} \,dt^{\prime}\right|^2 \Bigg) + \Od{\lambda^2}.\nonumber
\end{align}
