...
\Delta S = 
-\lambda &\sum_{n \in I}\overline{\sigma_n^{(1)}}\left(1+\log\overline{\sigma_n^{(0)}}\right)+ \left(\lambda^{k}\log\frac{1}{\lambda^k}\right)\sum_{n \not\in I}\overline{\sigma_n^{(2)}} - \lambda^k\sum_{n \not\in I}\overline{\sigma_n^{(2)}} \log\overline{\sigma_n^{(2)}}\\&+\lambda^2\left(- \sum_{n \in I}\overline{\sigma_n^{(2)}}- \sum_{n \in I}\overline{\sigma_n^{(2)}}\log\overline{\sigma_n^{(0)}}- \sum_{n \in I}\frac{\overline{\sigma_n^{(1)}}^2}{\sigma_n^{(0)}}\right)\nonumber\\&+ \Od{\lambda^3} + \Od{\lambda^{k+1}\log\frac{1}{\lambda^{k+1}}}.\nonumber
\end{empheq}
